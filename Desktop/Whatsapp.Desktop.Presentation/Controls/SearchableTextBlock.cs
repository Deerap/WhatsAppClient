...
namespace Whatsapp.Desktop.Presentation.Controls
{
    public class SearchableTextBlock : Control
    {
        static SearchableTextBlock()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(SearchableTextBlock),
                new FrameworkPropertyMetadata(typeof(SearchableTextBlock)));
        }
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(SearchableTextBlock),
        ...
        public static readonly DependencyProperty HighlightBackgroundProperty =
            DependencyProperty.Register("HighlightBackground", typeof(Brush), typeof(SearchableTextBlock),
            new UIPropertyMetadata(new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFcfdff2")), UpdateControlCallBack));
        ...
        public static readonly DependencyProperty HighlightForegroundProperty =
            DependencyProperty.Register("HighlightForeground", typeof(Brush), typeof(SearchableTextBlock),
        ...
        public static readonly DependencyProperty IsMatchCaseProperty =
            DependencyProperty.Register("IsMatchCase", typeof(bool), typeof(SearchableTextBlock),
        ...
        public static readonly DependencyProperty IsHighlightProperty =
            DependencyProperty.Register("IsHighlight", typeof(bool), typeof(SearchableTextBlock),
        ...
        public static readonly DependencyProperty SearchTextProperty =
            DependencyProperty.Register("SearchText", typeof(string), typeof(SearchableTextBlock),
        ...
        {
            SearchableTextBlock obj = d as SearchableTextBlock;
        ...
        {            
            ...
            displayTextBlock.VerticalAlignment = this.VerticalAlignment;
            displayTextBlock.FontWeight = this.FontWeight;
            ...
            if (!this.IsHighlight || string.IsNullOrEmpty(this.SearchText))
            {
